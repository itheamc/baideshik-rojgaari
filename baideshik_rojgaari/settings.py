"""
Django settings for baideshik_rojgaari project.
...
SECRET_KEY = 'django-insecure-c9fvd%qh3@e@dl6^mg*3i6ew^cx4rca3mgjrqn(=xsys2t_m0l'
...
ROOT_URLCONF = 'baideshik_rojgaari.urls'
...
WSGI_APPLICATION = 'baideshik_rojgaari.wsgi.application'
